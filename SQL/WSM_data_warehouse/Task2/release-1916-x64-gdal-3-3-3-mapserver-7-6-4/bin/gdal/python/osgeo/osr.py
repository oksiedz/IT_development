...
class AreaOfUse(_object):
    ...
    if _newclass:west_lon_degree = _swig_property(_osr.AreaOfUse_west_lon_degree_get)
    __swig_getmethods__["south_lat_degree"] = _osr.AreaOfUse_south_lat_degree_get
    if _newclass:south_lat_degree = _swig_property(_osr.AreaOfUse_south_lat_degree_get)
    __swig_getmethods__["east_lon_degree"] = _osr.AreaOfUse_east_lon_degree_get
    if _newclass:east_lon_degree = _swig_property(_osr.AreaOfUse_east_lon_degree_get)
    __swig_getmethods__["north_lat_degree"] = _osr.AreaOfUse_north_lat_degree_get
    if _newclass:north_lat_degree = _swig_property(_osr.AreaOfUse_north_lat_degree_get)
    __swig_getmethods__["name"] = _osr.AreaOfUse_name_get
    if _newclass:name = _swig_property(_osr.AreaOfUse_name_get)
...
class SpatialReference(_object):
    ...
    def DemoteTo2D(self, *args):
        """DemoteTo2D(self, char name = None) -> OGRErr"""
...
class CoordinateTransformation(_object):
    ...
    def TransformPointWithErrorCode(self, *args):
        """TransformPointWithErrorCode(self, double x, double y, double z, double t)"""
...
class CRSInfo(_object):
    ...
    if _newclass:auth_name = _swig_property(_osr.CRSInfo_auth_name_get)
    __swig_getmethods__["code"] = _osr.CRSInfo_code_get
    if _newclass:code = _swig_property(_osr.CRSInfo_code_get)
    __swig_getmethods__["name"] = _osr.CRSInfo_name_get
    if _newclass:name = _swig_property(_osr.CRSInfo_name_get)
    __swig_getmethods__["type"] = _osr.CRSInfo_type_get
    if _newclass:type = _swig_property(_osr.CRSInfo_type_get)
    __swig_getmethods__["deprecated"] = _osr.CRSInfo_deprecated_get
    if _newclass:deprecated = _swig_property(_osr.CRSInfo_deprecated_get)
    __swig_getmethods__["bbox_valid"] = _osr.CRSInfo_bbox_valid_get
    if _newclass:bbox_valid = _swig_property(_osr.CRSInfo_bbox_valid_get)
    __swig_getmethods__["west_lon_degree"] = _osr.CRSInfo_west_lon_degree_get
    if _newclass:west_lon_degree = _swig_property(_osr.CRSInfo_west_lon_degree_get)
    __swig_getmethods__["south_lat_degree"] = _osr.CRSInfo_south_lat_degree_get
    if _newclass:south_lat_degree = _swig_property(_osr.CRSInfo_south_lat_degree_get)
    __swig_getmethods__["east_lon_degree"] = _osr.CRSInfo_east_lon_degree_get
    if _newclass:east_lon_degree = _swig_property(_osr.CRSInfo_east_lon_degree_get)
    __swig_getmethods__["north_lat_degree"] = _osr.CRSInfo_north_lat_degree_get
    if _newclass:north_lat_degree = _swig_property(_osr.CRSInfo_north_lat_degree_get)
    __swig_getmethods__["area_name"] = _osr.CRSInfo_area_name_get
    if _newclass:area_name = _swig_property(_osr.CRSInfo_area_name_get)
    __swig_getmethods__["projection_method"] = _osr.CRSInfo_projection_method_get
    if _newclass:projection_method = _swig_property(_osr.CRSInfo_projection_method_get)
    def __init__(self, *args): 
        """
...
def SetPROJAuxDbPath(*args):
  """SetPROJAuxDbPath(char utf8_path)"""
