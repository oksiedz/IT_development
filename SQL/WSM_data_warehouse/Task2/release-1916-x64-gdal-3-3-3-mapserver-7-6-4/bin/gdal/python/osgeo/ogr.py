...
class PreparedGeometry(_object):
    ...
    __del__ = lambda self : None;
    def Intersects(self, *args):
        """Intersects(self, Geometry otherGeom) -> bool"""
        return _ogr.PreparedGeometry_Intersects(self, *args)

    def Contains(self, *args):
        """Contains(self, Geometry otherGeom) -> bool"""
...
class FieldDomain(_object):
    ...
    def SetSplitPolicy(self, *args):
        """SetSplitPolicy(self, OGRFieldDomainSplitPolicy policy)"""
    ...
    def SetMergePolicy(self, *args):
        """SetMergePolicy(self, OGRFieldDomainMergePolicy policy)"""
        return _ogr.FieldDomain_SetMergePolicy(self, *args)

    def GetEnumeration(self, *args):
        """GetEnumeration(self) -> OGRCodedValue"""
...
def CreateCodedFieldDomain(*args):
  """
    CreateCodedFieldDomain(char name, char description, OGRFieldType type, OGRFieldSubType subtype, 
        OGRCodedValue enumeration) -> FieldDomain
    """
  return _ogr.CreateCodedFieldDomain(*args)

def CreateRangeFieldDomain(*args):
  """
    CreateRangeFieldDomain(char name, char description, OGRFieldType type, OGRFieldSubType subtype, 
        double min, bool minIsInclusive, 
        double max, double maxIsInclusive) -> FieldDomain
    """
  return _ogr.CreateRangeFieldDomain(*args)

def CreateGlobFieldDomain(*args):
  """
    CreateGlobFieldDomain(char name, char description, OGRFieldType type, OGRFieldSubType subtype, 
        char glob) -> FieldDomain
    """
